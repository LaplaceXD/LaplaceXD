    ...
    -- use {
        ...
        use {
            ...
            config = function()
                ...
                vim.api.nvim_set_keymap("n", "<leader>ff", ":Prettier<cr>", { silent = true })
                vim.api.nvim_set_keymap("x", "<leader>ff", ":Prettier<cr>", { silent = true })
            end
        }
        ...
        use {
            ...
            config = function ()
                require("auto-save").setup {
                    trigger_events = {"InsertLeave", "TextChanged", "FocusLost", "VimLeavePre"},
                }
            end
        }
