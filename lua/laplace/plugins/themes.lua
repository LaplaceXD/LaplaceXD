		...
		config = function(_, opts)
			...
			require("material").setup(vim.tbl_deep_extend("force", opts, {
				custom_highlights = {
					...
					["@keyword.typescript"] = { fg = colors.main.cyan },
					["@keyword.function.typescript"] = { fg = colors.main.cyan },
					["@keyword.tsx"] = { fg = colors.main.cyan },
					["@keyword.function.tsx"] = { fg = colors.main.cyan },
